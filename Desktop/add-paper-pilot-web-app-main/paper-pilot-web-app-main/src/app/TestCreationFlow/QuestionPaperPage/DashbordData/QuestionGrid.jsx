            ...
            {/* View mode toggle */}
             <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                      <button 
                        ...
                        className={`p-1 transition-colors duration-200 ${viewMode === 'grid' ? 'bg-gray-100 text-gray-800' : 'text-gray-500 hover:bg-gray-50'}`}
                      ...
                      <button 
                        ...
                        className={`p-1 transition-colors duration-200 ${viewMode === 'list' ? 'bg-gray-100 text-gray-800' : 'text-gray-500 hover:bg-gray-50'}`}
