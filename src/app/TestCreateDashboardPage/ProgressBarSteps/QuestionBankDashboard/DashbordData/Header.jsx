...
const Header = ({ toggleSidebar, showSidebar, onAddNew, selectedCount }) => {
  ...
  return (
    <header className={`${themeClasses.headerBackground} border-b px-4 py-3 flex items-center justify-between`}>
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          {selectedCount > 0 && (
            <span className={`${themeClasses.badgeBackground} text-xs font-medium px-2.5 py-0.5 rounded-full`}>
      ...
      <div className="flex items-center space-x-3">
        <div className="relative">
          ...
          <input
            ...
            className={`pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:border-transparent ${themeClasses.inputBase}`}
          />
        </div>
