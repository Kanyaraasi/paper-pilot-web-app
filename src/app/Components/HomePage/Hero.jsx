        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className={`w-full lg:w-7/12 ${themeClasses.textPrimary} space-y-8 ${
            ...
            <div className="space-y-2">
              <div className={`inline-flex items-center mt-8 ${themeClasses.alertInfo} px-4 py-2 rounded-full border`}>
                <span className="flex h-2 w-2 relative mr-3">
                  <span className={`animate-ping absolute h-2 w-2 rounded-full ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-400'} opacity-75`}></span>
                  <span className={`relative rounded-full h-2 w-2 ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-500'}`}></span>
                </span>
                <span className="text-sm font-medium">✨ PaperPilot Generation</span>
              </div>
              
              <h1 className={`text-2xl md:text-5xl font-bold leading-tight ${
                theme === 'dark' 
                  ? 'bg-gradient-to-r from-gray-100 via-blue-200 to-indigo-200 bg-clip-text text-transparent' 
            ...
            <div className="h-10 md:h-10 mt-1">
              <h2 className={`text-2xl md:text-3xl font-semibold ${
                ...
                <span>{typedText}</span>
                <span className={`animate-pulse ${themeClasses.iconAccent}`}>|</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className={`flex items-center space-x-3 ${themeClasses.subjectCard} p-4 rounded-lg border shadow-sm hover:shadow-md transition-all`}>
                ...
                <div>
                  <h3 className={`font-semibold ${themeClasses.textPrimary}`}>Lightning Fast</h3>
                  <p className={`text-sm ${themeClasses.textSecondary}`}>Generate papers in under 60 seconds</p>
                </div>
              </div>
              ...
              <div className={`flex items-center space-x-3 ${themeClasses.subjectCard} p-4 rounded-lg border shadow-sm hover:shadow-md transition-all`}>
                ...
                <div>
                  <h3 className={`font-semibold ${themeClasses.textPrimary}`}>Curriculum Aligned</h3>
                  <p className={`text-sm ${themeClasses.textSecondary}`}>State boards supported</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4">
              <a href='/TestHistorySavedDashboard'>
                <button className={`group px-8 py-4 ${themeClasses.buttonPrimary} rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl transform hover:scale-105 duration-300 flex items-center justify-center`}>
