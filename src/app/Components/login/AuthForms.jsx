...
function AuthForms() {
  ...
  return (
    <div className="bg-white p-2 rounded-xl shadow-xl w-full max-w-md mx-auto border border-gray-100 hover:shadow-2xl transition-shadow duration-500 relative overflow-hidden">
      ...
      <div className="flex mb-6 bg-gray-100 rounded-lg p-1">
        <button 
          ...
          className={`flex-1 py-2 rounded-3xl font-medium text-sm transition-all duration-300 ${
            !isRegisterForm ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-gray-200'
          }`}
        >
          Login
        </button>
      ...
      {/* Alert Messages */}
      {error && (
        <div className="bg-red-100 border-l-4 border-red-500 text-red-700 px-4 py-3 rounded relative animate-shake mb-4" role="alert">
      ...
      <div className={`transition-all duration-500 transform ${
        isRegisterForm ? 'translate-x-full opacity-0 absolute inset-0 pointer-events-none' : 'translate-x-0 opacity-100'
      }`} style={{padding: "1rem"}}>
