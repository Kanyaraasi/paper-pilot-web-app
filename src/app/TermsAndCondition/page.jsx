    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-indigo-400 to-blue-600 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <Link href="/dashboard" className="flex items-center text-white font-medium hover:text-blue-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 flex justify-center">
          <Link href="/QuestionPaperPage" className="flex items-center gap-2 text-blue-600 hover:text-blue-800">
            <ArrowLeft size={16} />
            Back to Dashboard
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link href="/help" className="text-gray-500 hover:text-gray-700 text-sm">Help</Link>
              <Link href="/terms" className="text-blue-600 hover:text-blue-800 text-sm">Terms</Link>
