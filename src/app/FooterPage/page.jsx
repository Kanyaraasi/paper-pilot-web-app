...
const Footer = () => {
  ...
  return (
    <footer className={`bg-offWhite transition-colors duration-200`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0">
            <p
              className={`text-center md:text-right text-base ${themeClasses.textMuted}`}
            >
        ...
        <div className={`mt-8 border-t ${themeClasses.cardHeader} pt-8`}>
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 flex items-center justify-center md:justify-end">
              <span
                className={`text-sm ${themeClasses.textMuted} flex items-center`}
              >
