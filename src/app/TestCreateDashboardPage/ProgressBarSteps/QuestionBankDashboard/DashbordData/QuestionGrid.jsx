  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        <div className={`inline-flex items-center px-4 py-2 text-sm ${themeClasses.textSecondary} font-inter`}>
  ...
  if (filteredQuestions.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className={`text-lg font-medium ${themeClasses.textPrimary} mb-2 font-inter`}>
          No questions found
        </h3>
      </div>
    );
